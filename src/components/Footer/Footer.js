    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        ...
        <div className={styles.footerCol}>
          ...
          <ul className={styles.footerList}>
            <li><Link href="/#services">Residential Interior</Link></li>
            <li><Link href="/#services">Commercial Interior</Link></li>
            <li><Link href="/design-gallery?category=modular-kitchen">Modular Kitchen</Link></li>
            <li><Link href="/#services">Furniture & Decor</Link></li>
            <li><Link href="/#services">Turnkey Projects</Link></li>
            <li><Link href="/#services">3D Design & Visual</Link></li>
          </ul>
        </div>
