      ...
      <div className={styles.footerContainer}>
        <div className={styles.footerCol}>
          <div className={styles.footerLogo}>
            ...
            <img src="/name_img.png" alt="Forever Dreams Home" className={styles.nameImgFooter} style={{ height: '40px', width: 'auto', objectFit: 'contain', filter: 'brightness(0) invert(1)', transform: 'scale(2.2)', transformOrigin: 'left center', marginLeft: '15px' }} />
          </div>
